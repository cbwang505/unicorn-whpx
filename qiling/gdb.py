    ...
    def run(self):
        ...
        def handle_q(subcmd: str) -> Reply:
            ...
            if query == 'Supported':
                ...
                if feature == 'features' and op == 'read':
                    ...
                    return f'l{self.ql.os.path.virtual_to_host_path(self.ql.image)}'
        ...
        def handle_Z(subcmd: str) -> Reply:
            ...
            if type == 1 or type == 2 or type == 3:
                success = self.gdb.bp_insert_hw(addr, kind,type)
                return REPLY_OK if success else 'E22'
